...
<head>
    ...
    @if (app()->getLocale() == 'ar')
    <link rel="stylesheet" href="{{asset('frontend/css/style-ar.css')}}" type="text/css">
    @else
...
<body>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
                        <div class="footer__copyright__payment"><img src="{{ asset('frontend/payment-item.png')}}" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
